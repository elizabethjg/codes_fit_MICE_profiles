...
class Sigma_fit:
    ...
    def __init__(self,R,Sigma,err,z,model='NFW',Min=1.e13,cin=3.):
        ...
        try:
            ...
            out = p.fit(R*1000., Sigma/(1.e3**2), 'Sigma', q_err = err/(1.e3**2), tolerance = 1.e-06,verbose=False)
...
class rho_fit:
    ...
    def __init__(self,R,rho,err,z,model='NFW',Min=1.e13,cin=3.):
        ...
        try:
            ...
            out = p.fit(R*1000., rho/(1.e3**3), 'rho', q_err = err/(1.e3**3), tolerance = 1.e-06,verbose=False)
