...
jmax = np.argsort(rc)[-5]
jmin = np.argsort(rc)[3]

js = [jmin,jmax]

f, axall = plt.subplots(2,3, figsize=(12.7,8))
...
# part0 = np.loadtxt('/mnt/projects/lensing/HALO_SHAPE/MICEv1.0/catalogs/ind_halos/coords'+str(ides[j])).T  
    ...
    print(main.redshift[j])
    print(rc[j]/main.r_max[j])
    ...
    ax[0].plot(x,y,'C7o',alpha=0.1)
    ax[1].plot(x,z,'C7o',alpha=0.1)
    ax[2].plot(y,z,'C7o',alpha=0.1)
    ax[0].plot(x,y,'C7,')
    ax[1].plot(x,z,'C7,')
    ax[2].plot(y,z,'C7,')
    ax[0].plot(x,y,'C2o',alpha=0.005)
    ax[1].plot(x,z,'C2o',alpha=0.005)
    ax[2].plot(y,z,'C2o',alpha=0.005)
    ax[0].plot(x0,y0,'C3o')
    ax[1].plot(x0,z0,'C3o')
    ax[2].plot(y0,z0,'C3o')
    ax[0].plot(0,0,'C1o')
...
f.savefig(plot_path+'coords.png',bbox_inches='tight')
